...
[![GoDoc](https://godoc.org/github.com/georgiosB/overseer?status.svg)](https://godoc.org/github.com/georgiosB/overseer)   [![Tests](https://github.com/georgiosB/overseer/workflows/Tests/badge.svg)](https://github.com/georgiosB/overseer/actions?workflow=Tests)
...
```sh
go get github.com/georgiosB/overseer
```
...
import (
	...
	"github.com/georgiosB/overseer"
	"github.com/georgiosB/overseer/fetcher"
)
...
See [Config](https://godoc.org/github.com/georgiosB/overseer#Config)uration options [here](https://godoc.org/github.com/georgiosB/overseer#Config) and the runtime [State](https://godoc.org/github.com/georgiosB/overseer#State) available to your program [here](https://godoc.org/github.com/georgiosB/overseer#State).
...
* [Core `overseer` package](https://godoc.org/github.com/georgiosB/overseer)
* [Common `fetcher.Interface`](https://godoc.org/github.com/georgiosB/overseer/fetcher#Interface)
	* [File fetcher](https://godoc.org/github.com/georgiosB/overseer/fetcher#File)
	* [HTTP fetcher](https://godoc.org/github.com/georgiosB/overseer/fetcher#HTTP)
	* [S3 fetcher](https://godoc.org/github.com/georgiosB/overseer/fetcher#S3)
	* [Github fetcher](https://godoc.org/github.com/georgiosB/overseer/fetcher#Github)
